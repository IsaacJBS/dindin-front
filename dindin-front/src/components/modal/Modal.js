...
import closeModal from '../../assets/closeBtn.svg';
        ...
        <div className={`modal ${modal.aberto ? "" : "hidden"}`}>
            <div className="modal-container">
                ...
                <form className="modal-form">
                    ...
                    <button type="submit" className="btn-insert" onClick={handleAdd}>Confirmar</button>
                </form>
            </div>
        </div>
    )
